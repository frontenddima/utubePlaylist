 ...
 */
$OAUTH2_CLIENT_ID = '376788227486-j6nm106qr8kj8fv65ti1nkm9is75h3q3.apps.googleusercontent.com';
$OAUTH2_CLIENT_SECRET = '4afqNmT2lWDvCxt_Z65_EGnR';
...
//    $playlistSnippet->setTitle('Check');
//    $playlistSnippet->setChannelId('');
//    $playlistSnippet->setDescription(' Check Playlist');
//    $playlistSnippet->setChannelId('UCdQTqluXS0qerVpLOp8RJ6w');
//
...
//        $youTubePlaylist, array());
    ...
    $playlistId = 'PLM7Ttm0TBmAQMjx30ybeUHKOSXPl84OvW';
    ...
    $resourceId->setVideoId('OI52ZM4SOUg');
...
<body>
  <? echo  'Playlist sucessfully added';?>
</body>
</html>
